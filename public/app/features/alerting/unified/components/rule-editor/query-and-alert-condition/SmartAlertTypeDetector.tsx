    ...
    <Stack direction="column" gap={1} alignItems="flex-start">
          ...
          <NeedHelpInfo
            contentText={
              <>
                ...
                <p>
                  <Trans i18nKey="alerting.smart-alert-type-detector.gma-description">
                ...
                <p>
                  <Trans i18nKey="alerting.smart-alert-type-detector.dma-description">
      ...
      {editingExistingRule && (
        <Text color="secondary">
          <Trans i18nKey="alerting.smart-alert-type-detector.cannot-change-existing-rule">
          ...
          {canSwitch ? (
            <Text color="secondary">
              {ruleFormType === RuleFormType.grafana
                ? t(
                    'alerting.smart-alert-type-detector.data-source-supports-alert-rule-management',
                ...
                : t(
                    'alerting.smart-alert-type-detector.grafana-managed-features',
                    'Switch to Grafana-managed to use expressions, multiple queries, images in notifications and various other features.'
                  )}
            </Text>
          ) : (
            <Text color="secondary">
              <Trans i18nKey="alerting.smart-alert-type-detector.based-on-selected-data-sources">
